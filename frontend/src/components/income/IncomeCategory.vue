...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            createCategory() {
                axios.post('http://127.0.0.1:3333/income-category', {
                    name: this.form.name})
                    .then(res => {
                        this.form.name = ''
                        console.log(res.data)
            ...
            updateCategory() {
                axios.put('http://127.0.0.1:3333/income-category/'+this.form.id, {
                    name: this.form.name})
                    .then(res => {
                        this.form.name = ''
                        console.log(res.data)
            ...
            deleteCategory(cat) {
                axios.delete('http://127.0.0.1:3333/income-category/'+cat.id)
                    .then(res => {
                        console.log(res.data)
                        this.getIncomeCategories()
                    })
